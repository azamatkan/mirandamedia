...
export default function CaseStudyFlorbal() {
  ...
  return (
    <div className="bg-dark-navy text-slate-300 min-h-screen font-sans selection:bg-neon-green selection:text-slate-900">
      ...
      {/* Dynamic Island TOC */}
      <DynamicIslandToc
        ctaText="To je přesně to, co hledám"
        ctaHref="#contact"
      />
      ...
      <article>
        {/* Section 01: Představení klienta */}
        <section className="scroll-mt-32 py-32 border-b border-white/5 relative overflow-hidden">
          <div className="max-w-7xl mx-auto px-6 relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-start">
              ...
              <div className="space-y-12">
                <div className="relative">
                  ...
                  />
                  <h2 id="predstaveni" className="text-4xl lg:text-6xl font-bold text-white tracking-tighter mb-12 whitespace-nowrap">
                    Představení klienta
                  </h2>
                </div>
        ...
        <section className="scroll-mt-32 py-32 relative">
            ...
            <div className="space-y-32">
              <div className="relative">
                <img
                  ...
                  className="w-48 h-auto mb-12"
                />
                <h2 id="realizace" className="text-4xl lg:text-7xl font-bold text-white tracking-tighter mb-12">
                  Realizace projektu
                </h2>
              </div>

              {/* Sub-section: Grafický design */}
              <div className="space-y-12 scroll-mt-40">
                <div className="max-w-4xl space-y-6">
                  <h3 id="graficky-design" className="text-3xl font-bold text-white">Grafický design</h3>
              ...
              <div className="space-y-12 scroll-mt-40">
                <div className="max-w-4xl space-y-6">
                  <h3 id="migrace-dat" className="text-3xl font-bold text-white">Migrace dat</h3>
                  <p className="text-lg leading-relaxed text-slate-400">
              ...
              <div className="space-y-12 scroll-mt-40">
                <div className="max-w-4xl space-y-6">
                  <h3 id="nastaveni-admin" className="text-3xl font-bold text-white">Nastavení administrace a doplňků Shoptet</h3>
                  <p className="text-lg leading-relaxed text-slate-400">
        ...
        <section className="scroll-mt-32 py-32 relative">
          <div className="max-w-7xl mx-auto px-6">
            <div className="space-y-32">
              <div className="relative">
                <img
                  src="/case-studies/florbalexpert/3.png"
                  alt="03"
                  className="w-48 h-auto mb-12"
                />
                <h2 id="technicke-reseni" className="text-4xl lg:text-7xl font-bold text-white tracking-tighter mb-12">
                  Technické řešení
                </h2>
              </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
                <div className="space-y-8">
                  <h3 id="integrace-erp" className="text-3xl font-bold text-white">Integrace e-shopu Shoptet s ERP ABRA</h3>
                ...
                <div className="relative hidden lg:block">
                  <img
                    src="/case-studies/florbalexpert/image8.png"
                    alt="Florbalexpert arena"
                    className="w-[90%] h-auto rounded-2xl shadow-2xl"
                  />
                  <img
                    src="/case-studies/florbalexpert/image7.png"
                    alt="Florbalexpert blade case"
                    className="absolute -bottom-16 -right-4 w-[45%] h-auto rounded-2xl shadow-2xl z-10 border-4 border-dark-navy"
                  />
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
              <div>
                <div className="relative mb-12">
                  <img
                    src="/case-studies/florbalexpert/4.png"
                    alt="04"
                    className="w-48 h-auto mb-12"
                  />
                  <h2 id="vysledek" className="text-4xl lg:text-7xl font-bold text-white tracking-tighter flex items-center gap-6">
              ...
              <div className="relative hidden lg:block">
                <img
                  src="/case-studies/florbalexpert/image10.png"
                  alt="Florbalexpert výsledek"
                  className="w-[90%] ml-auto h-auto rounded-2xl shadow-2xl"
                />
                <img
                  src="/case-studies/florbalexpert/image.png"
                  alt="Florbalexpert produkt"
                  className="absolute -bottom-16 left-0 w-[45%] h-auto rounded-2xl shadow-2xl z-10 border-4 border-dark-navy"
                />
              </div>
              <div className="flex flex-col gap-6 lg:hidden">
                <img
